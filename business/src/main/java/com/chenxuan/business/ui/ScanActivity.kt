...
import com.chenxuan.business.databinding.BusinessActivityScanBinding
...
class ScanActivity : BaseSimpleActivity<BusinessActivityScanBinding>() {
    override fun createViewBinding() = BusinessActivityScanBinding.inflate(layoutInflater)
